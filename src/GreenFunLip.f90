!=====================================================================================================
! The subroutine calculates the distribution of a dencity and mass accretion rate over the radial coordinate
! in accretion disc.
! R_in, R_out - the inner and outer radii of accretion disc;
! R_ - the radial coordinate of initial distortion
...
! The roots are usen in a series which represents the Green function.
! root(n) - the array containing "n" roots of equation.
! l - parameter descibing evolution of viscosity in accretion disc with the radial coordinate.
! x_in and x_out - parameters determining the inner and outer edges of accretion disc.
! Assumptions: zero-stress at the inner radius, zero-mass-accretion-rate at the outer radius.
!=========================================================================================================
...
!==========================================================================================================================
! The function calculates the Green function for the mass accretion rate in the frequency domain.
! The calculations are based on semi-analytical manner.
...
integer::i
  ...
  !==summation over the roots of equation==!
...
! The derivative is calculated numerically here.
!==========================================================================================================================
...
integer::i
  ...
  GreenLip_F=GreenLip_F*sqrt(R)*6*pi *(R_out/R_in)**(2.d0-n)
...
! R_ - radial coordinate of initial distortion;
! t - time after the distortion at R_;
! R_in, R_out - inner and outer radii of accretion disc;
! n - describes the dependence of kinematic viscosity in accretion disc on radial coordinate;
! k_i(num) - array of a "num" roots of the transedental equation.
!================================================================================================
...
real*8::pi=3.141592653589793d0
integer::nn
  nn=2000     !==the number of points for integration over the radial coordinate==!
  dR=(R_out-R_in)/nn
  R=R_in
  res=0.d0
  do while(R.le.R_out)
